...
void setup() {
  ...
  if (bq.setVBatLowV(BQ25798_VBAT_LOWV_66_7_PERCENT)) {
    ...
    switch (bq.getVBatLowV()) {
      case BQ25798_VBAT_LOWV_15_PERCENT:
        Serial.println(F("15% of VREG"));
        break;
      case BQ25798_VBAT_LOWV_62_2_PERCENT:
        Serial.println(F("62.2% of VREG"));
        break;
      case BQ25798_VBAT_LOWV_66_7_PERCENT:
        Serial.println(F("66.7% of VREG"));
        break;
      case BQ25798_VBAT_LOWV_71_4_PERCENT:
        Serial.println(F("71.4% of VREG"));
        break;
    }
  } else {
  ...
  Serial.println(currentStopOnWDT ? "true (WDT will NOT reset safety timers)" :
  "false (WDT will reset safety timers)");
  ...
  */
  ...
  // bq.setCellCount(BQ25798_CELL_COUNT_2S); // Uncomment to set cell count if
  // desired
  Serial.print(F("Current cell count: "));
  bq25798_cell_count_t currentCellCount = bq.getCellCount();
  switch (currentCellCount) {
    case BQ25798_CELL_COUNT_1S:
      Serial.println(F("1S (1 cell)"));
      break;
    case BQ25798_CELL_COUNT_2S:
      Serial.println(F("2S (2 cells)"));
      break;
    case BQ25798_CELL_COUNT_3S:
      Serial.println(F("3S (3 cells)"));
      break;
    case BQ25798_CELL_COUNT_4S:
      Serial.println(F("4S (4 cells)"));
      break;
  }
  ...
  // bq.setRechargeDeglitchTime(BQ25798_TRECHG_256MS); // Uncomment to set
  // deglitch time if desired
  ...
  switch (currentDeglitchTime) {
    case BQ25798_TRECHG_64MS:
      Serial.println(F("64ms"));
      break;
    case BQ25798_TRECHG_256MS:
      Serial.println(F("256ms"));
      break;
    case BQ25798_TRECHG_1024MS:
      Serial.println(F("1024ms"));
      break;
    case BQ25798_TRECHG_2048MS:
      Serial.println(F("2048ms"));
      break;
  }
  ...
  // bq.setRechargeThreshOffsetV(0.15); // Uncomment to set recharge threshold
  // if desired
  ...
  // bq.setPrechargeTimer(BQ25798_PRECHG_TMR_0_5HR); // Uncomment to set timer
  // if desired
  Serial.print(F("Current precharge timer: "));
  bq25798_prechg_timer_t currentTimer = bq.getPrechargeTimer();
  switch (currentTimer) {
    case BQ25798_PRECHG_TMR_2HR:
      Serial.println(F("2 hours"));
      break;
    case BQ25798_PRECHG_TMR_0_5HR:
      Serial.println(F("0.5 hours"));
      break;
  }
  ...
  // bq.setTopOffTimer(BQ25798_TOPOFF_TMR_15MIN); // Uncomment to set timer if
  // desired
  Serial.print(F("Current top-off timer: "));
  bq25798_topoff_timer_t currentTopOffTimer = bq.getTopOffTimer();
  switch (currentTopOffTimer) {
    case BQ25798_TOPOFF_TMR_DISABLED:
      Serial.println(F("Disabled"));
      break;
    case BQ25798_TOPOFF_TMR_15MIN:
      Serial.println(F("15 minutes"));
      break;
    case BQ25798_TOPOFF_TMR_30MIN:
      Serial.println(F("30 minutes"));
      break;
    case BQ25798_TOPOFF_TMR_45MIN:
      Serial.println(F("45 minutes"));
      break;
  }
  ...
  // bq.setTrickleChargeTimerEnable(false); // Uncomment to disable timer if
  // desired
  ...
  // bq.setFastChargeTimerEnable(false); // Uncomment to disable timer if
  // desired
  ...
  // bq.setFastChargeTimer(BQ25798_CHG_TMR_8HR); // Uncomment to set timer if
  // desired
  ...
  switch (currentFastChargeTimer) {
    case BQ25798_CHG_TMR_5HR:
      Serial.println(F("5 hours"));
      break;
    case BQ25798_CHG_TMR_8HR:
      Serial.println(F("8 hours"));
      break;
    case BQ25798_CHG_TMR_12HR:
      Serial.println(F("12 hours"));
      break;
    case BQ25798_CHG_TMR_24HR:
      Serial.println(F("24 hours"));
      break;
  }
  ...
  // bq.setTimerHalfRateEnable(false); // Uncomment to disable half-rate if
  // desired
  ...
  // bq.setTerminationEnable(false); // Uncomment to disable termination if
  // desired
  ...
  // bq.setBackupModeThresh(BQ25798_VBUS_BACKUP_60_PERCENT); // Uncomment to set
  ...
  switch (currentBackupThresh) {
    case BQ25798_VBUS_BACKUP_40_PERCENT:
      Serial.println(F("40% of VINDPM"));
      break;
    case BQ25798_VBUS_BACKUP_60_PERCENT:
      Serial.println(F("60% of VINDPM"));
      break;
    case BQ25798_VBUS_BACKUP_80_PERCENT:
      Serial.println(F("80% of VINDPM"));
      break;
    case BQ25798_VBUS_BACKUP_100_PERCENT:
      Serial.println(F("100% of VINDPM"));
      break;
  }
  ...
  switch (currentVACOVP) {
    case BQ25798_VAC_OVP_26V:
      Serial.println(F("26V"));
      break;
    case BQ25798_VAC_OVP_22V:
      Serial.println(F("22V"));
      break;
    case BQ25798_VAC_OVP_12V:
      Serial.println(F("12V"));
      break;
    case BQ25798_VAC_OVP_7V:
      Serial.println(F("7V"));
      break;
  }
  ...
  switch (currentWDT) {
    case BQ25798_WDT_DISABLE:
      Serial.println(F("Disabled"));
      break;
    case BQ25798_WDT_0_5S:
      Serial.println(F("0.5 seconds"));
      break;
    case BQ25798_WDT_1S:
      Serial.println(F("1 second"));
      break;
    case BQ25798_WDT_2S:
      Serial.println(F("2 seconds"));
      break;
    case BQ25798_WDT_20S:
      Serial.println(F("20 seconds"));
      break;
    case BQ25798_WDT_40S:
      Serial.println(F("40 seconds"));
      break;
    case BQ25798_WDT_80S:
      Serial.println(F("80 seconds"));
      break;
    case BQ25798_WDT_160S:
      Serial.println(F("160 seconds"));
      break;
  }
  ...
  // bq.setForceDPinsDetection(true); // Uncomment to force D+/D- detection if
  // desired
  ...
  // bq.setAutoDPinsDetection(false); // Uncomment to disable auto D+/D-
  ...
  // bq.setShipFETmode(BQ25798_SDRV_SHIP); // Uncomment to set ship mode if
  // desired
  Serial.print(F("Current ship FET mode: "));
  bq25798_sdrv_ctrl_t currentShipMode = bq.getShipFETmode();
  switch (currentShipMode) {
    case BQ25798_SDRV_IDLE:
      Serial.println(F("IDLE"));
      break;
    case BQ25798_SDRV_SHUTDOWN:
      Serial.println(F("Shutdown Mode"));
      break;
    case BQ25798_SDRV_SHIP:
      Serial.println(F("Ship Mode"));
      break;
    case BQ25798_SDRV_SYSTEM_RESET:
      Serial.println(F("System Power Reset"));
      break;
  }
  ...
  // bq.setShipWakeupDelay(BQ25798_WKUP_DLY_15MS); // Uncomment to set wakeup
  // delay if desired
  ...
  switch (currentWakeupDelay) {
    case BQ25798_WKUP_DLY_1S:
      Serial.println(F("1 second"));
      break;
    case BQ25798_WKUP_DLY_15MS:
      Serial.println(F("15ms"));
      break;
  }
  ...
  // bq.setBATFETLDOprecharge(false); // Uncomment to disable BATFET LDO
  // precharge if desired
  ...
  // bq.setPWMFrequency(BQ25798_PWM_FREQ_750KHZ); // Uncomment to set PWM
  ...
  switch (currentPWMFreq) {
    case BQ25798_PWM_FREQ_1_5MHZ:
      Serial.println(F("1.5 MHz"));
      break;
    case BQ25798_PWM_FREQ_750KHZ:
      Serial.println(F("750 kHz"));
      break;
  }
  ...
  // bq.setVSYSshortProtect(false); // Uncomment to disable VSYS short
  ...
  // bq.setVOTG_UVPProtect(false); // Uncomment to disable VOTG UVP protection
  // if desired
  ...
  // bq.setVINDPMdetection(false); // Uncomment to disable VINDPM detection if
  // desired
  ...
  // bq.setShipFETpresent(false); // Uncomment to disable ship FET present if
  // desired
  ...
  // bq.setBatDischargeSenseEnable(false); // Uncomment to disable battery
  // discharge sense if desired
  ...
  // bq.setBatDischargeA(BQ25798_IBAT_REG_4A); // Uncomment to set discharge
  // current if desired
  ...
  switch (currentBatDischarge) {
    case BQ25798_IBAT_REG_3A:
      Serial.println(F("3A"));
      break;
    case BQ25798_IBAT_REG_4A:
      Serial.println(F("4A"));
      break;
    case BQ25798_IBAT_REG_5A:
      Serial.println(F("5A"));
      break;
    case BQ25798_IBAT_REG_DISABLE:
      Serial.println(F("Disabled"));
      break;
  }
  ...
  // bq.setExtILIMpin(false); // Uncomment to disable external ILIM pin if
  // desired
  ...
  // bq.setBatDischargeOCPenable(false); // Uncomment to disable battery
  // discharge OCP if desired
  ...
  // bq.setVINDPM_VOCpercent(BQ25798_VOC_PCT_75); // Uncomment to set VOC
  ...
  switch (currentVOCpct) {
    case BQ25798_VOC_PCT_56_25:
      Serial.println(F("56.25%"));
      break;
    case BQ25798_VOC_PCT_62_5:
      Serial.println(F("62.5%"));
      break;
    case BQ25798_VOC_PCT_68_75:
      Serial.println(F("68.75%"));
      break;
    case BQ25798_VOC_PCT_75:
      Serial.println(F("75%"));
      break;
    case BQ25798_VOC_PCT_81_25:
      Serial.println(F("81.25%"));
      break;
    case BQ25798_VOC_PCT_87_5:
      Serial.println(F("87.5%"));
      break;
    case BQ25798_VOC_PCT_93_75:
      Serial.println(F("93.75%"));
      break;
    case BQ25798_VOC_PCT_100:
  ...
  // bq.setVOCdelay(BQ25798_VOC_DLY_2S); // Uncomment to set VOC delay if
  // desired
  Serial.print(F("Current VOC delay: "));
  bq25798_voc_dly_t currentVOCdelay = bq.getVOCdelay();
  switch (currentVOCdelay) {
    case BQ25798_VOC_DLY_50MS:
      Serial.println(F("50ms"));
      break;
    case BQ25798_VOC_DLY_300MS:
      Serial.println(F("300ms"));
      break;
    case BQ25798_VOC_DLY_2S:
      Serial.println(F("2 seconds"));
      break;
    case BQ25798_VOC_DLY_5S:
  ...
  // bq.setVOCrate(BQ25798_VOC_RATE_10MIN); // Uncomment to set VOC rate if
  // desired
  Serial.print(F("Current VOC measurement rate: "));
  bq25798_voc_rate_t currentVOCrate = bq.getVOCrate();
  switch (currentVOCrate) {
    case BQ25798_VOC_RATE_30S:
      Serial.println(F("30 seconds"));
      break;
    case BQ25798_VOC_RATE_2MIN:
      Serial.println(F("2 minutes"));
      break;
    case BQ25798_VOC_RATE_10MIN:
      Serial.println(F("10 minutes"));
      break;
    case BQ25798_VOC_RATE_30MIN:
      Serial.println(F("30 minutes"));
      break;
  }
  ...
  // bq.setThermRegulationThresh(BQ25798_TREG_100C); // Uncomment to set thermal
  // regulation threshold if desired
  Serial.print(F("Current thermal regulation threshold: "));
  bq25798_treg_t currentTREG = bq.getThermRegulationThresh();
  switch (currentTREG) {
    case BQ25798_TREG_60C:
      Serial.println(F("60°C"));
      break;
    case BQ25798_TREG_80C:
      Serial.println(F("80°C"));
      break;
    case BQ25798_TREG_100C:
      Serial.println(F("100°C"));
      break;
    case BQ25798_TREG_120C:
      Serial.println(F("120°C"));
      break;
  }
  ...
  // bq.setThermShutdownThresh(BQ25798_TSHUT_130C); // Uncomment to set thermal
  // shutdown threshold if desired
  Serial.print(F("Current thermal shutdown threshold: "));
  bq25798_tshut_t currentTSHUT = bq.getThermShutdownThresh();
  switch (currentTSHUT) {
    case BQ25798_TSHUT_150C:
      Serial.println(F("150°C"));
      break;
    case BQ25798_TSHUT_130C:
      Serial.println(F("130°C"));
      break;
    case BQ25798_TSHUT_120C:
      Serial.println(F("120°C"));
      break;
    case BQ25798_TSHUT_85C:
      Serial.println(F("85°C"));
      break;
  }
  ...
  // bq.setBackupACFET1on(true); // Uncomment to turn on backup ACFET1 if
  // desired
